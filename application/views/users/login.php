      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action="<?=base_url();?>users/login" method="post">
		        <h2 class="form-login-heading">Masuk Sistem</h2>
		        <?php
		        if ($error==1){
		        ?>
		        <div class="alert alert-danger">
		        	nama akun / kata sandi tidak cocok
		        </div>
				<?php		        	
		        }
		        ?>
		        ...
		        <div class="login-wrap">
		            <input name="user" id="username" type="text" class="form-control" placeholder="Nama Akun" autofocus>
		            <br>
		            <input name="pass" id="password" type="password" class="form-control" placeholder="Kata Sandi">
